...
function Set-TargetResource
{
    ...
    Write-Verbose -Message "Getting OOS version and config info from all servers"
...
function Install-OOSDscPatch
{
    ...
    switch ($setup.ExitCode)
    {
        0
        {
            Write-Verbose -Message "Office Online Server update binary installation complete."
        }
        17022
        {
            Write-Verbose -Message ("Office Online Server update binary installation complete, " + `
        ...
        17025
        {
            Write-Verbose -Message ("The Office Online Server update was already installed on your system." + `
                    "Please report an issue about this behavior at https://github.com/dsccommunity/OfficeOnlineServerDsc")
        }
        Default
        {
