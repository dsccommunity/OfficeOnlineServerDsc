...
$props += New-xDscResourceProperty -Name ExcelRestExternalDataAllowed -Type Boolean -Attribute Write -Description 'Specifies whether requests from the Representational State Transfer (REST) Application Programming Interface (API) are permitted to refresh external data connections.'
